...
public class OmsConfiguration extends BaseEntity {
    ...
    static {
        ...
        MenuTreeResponse p1s2 = new MenuTreeResponse("幸运盆配置","http");
        MenuTreeResponse p1s3 = new MenuTreeResponse("提现配置","http");
        MenuTreeResponse p1s4 = new MenuTreeResponse("广告配置","http");
        MenuTreeResponse p1s5 = new MenuTreeResponse("滚报配置","http");
        ...
        MenuTreeResponse p2s1 = new MenuTreeResponse("个人信息","http");
        MenuTreeResponse p2s2 = new MenuTreeResponse("游戏记录","http");
        MenuTreeResponse p2s3 = new MenuTreeResponse("金币变动","http");
        MenuTreeResponse p2s4 = new MenuTreeResponse("道具添加","http");
        ...
        MenuTreeResponse p3s1 = new MenuTreeResponse("登录日志","http");
        MenuTreeResponse p3s2 = new MenuTreeResponse("留存汇总","http");
        p3.getChildren().add(p3s1);p3.getChildren().add(p3s2);

        MenuTreeResponse p4 = new MenuTreeResponse("系统管理",null);
        MenuTreeResponse p4s1 = new MenuTreeResponse("用户管理","http");
        MenuTreeResponse p4s2 = new MenuTreeResponse("操作日志","http");
